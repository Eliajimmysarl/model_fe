				...
				<form method="POST" action="index.php?demande=ajout_un"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
                    ...
                    <div class="form-group"> 
						...
						<div class="col-sm-offset-3 col-sm-5"> 
							...
							<div class="radio"> 
								<label> 
									<input type="radio" name="optionsRadios" id="optionsRadios1" value="1" checked="">Radio Input 1
								</label> 
							</div>

							<div class="radio">
								<label> 
									<input type="radio" name="optionsRadios" id="optionsRadios2" value="2">Radio Input 2
								</label>   
							</div> 
