<hr/>
	<ol class="breadcrumb bc-3" >
		...
		<li>
			<a href="?page=recuperer_modeles">Plusieurs</a>
		</li>
		...
		<div class="col-md-12">
			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body">
					...
					<form method="POST" action="index.php?page=suppression_plusieurs"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
						...
						<div class="form-group">
							...
							<div class="col-sm-offset-3 col-sm-5">
								...
								<i class="entypo-right-open-mini">Supprimer</i>
